...
class Network(Session):
    ...
    def get(self, url: Type[str], query_params: Type[Dict] = {}, headers: Type[Dict] = {}, **kwargs) -> Type[Dict]:
        request = Request(method='GET', url=url, params=query_params, headers=headers, **kwargs)
